...
import { commentPost, deleteSinglePost, fetchSinglePost, likePost } from "../api";
import moment from "moment";
import { FaHeart, FaRegHeart, FaRegShareSquare, FaRegTrashAlt } from "react-icons/fa";
...
const Post = () => {
  ...
  const {user,user: {token: token}} = useSelector(state => state.user)
          ...
          <div className="bg-white rounded-lg p-3">
            <div className="p-3 flex  items-center">
              ...
              {post?.userId?._id == user?._id && (
                <div
                  onClick={() => {
                    mDeleteSinglePost({ token, uId: user?._id, postId: post?._id });
                  }}
